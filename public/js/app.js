...
recipeLayout(){
    ...
    <div class="nav-wrapper">
      <a href="#" class="brand-logo">Music Artist App</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
      <li>
      <a href="collapsible.html">Artist List</a>
      </li>
        <li>
        <a href="sass.html">Add Artist</a>
        </li>
        <li><a href="badges.html">Artist News</a>
        </li>
...
<p></p>
    <div class="carousel">
    <a class="carousel-item" href="#one!"><img src="img/pop.jpg"></a>
    <a class="carousel-item" href="#two!"><img src="img/country.jpg"></a>
    <a class="carousel-item" href="#three!"><img src="img/music.jpg"></a>
    <a class="carousel-item" href="#four!"><img src="img/m.jpg"></a>
